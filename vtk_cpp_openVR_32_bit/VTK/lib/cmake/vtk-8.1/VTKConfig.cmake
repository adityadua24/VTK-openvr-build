...
set(_vtk_installed_prefix "C:/Program Files (x86)/VTK/lib/cmake/vtk-8.1")
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Program Files (x86)/VTK/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Program Files (x86)/VTK/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "E:/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "E:/build/lib")
  endif ()
endif()
